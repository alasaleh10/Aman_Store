...
class SearchProdutcState with _$SearchProdutcState {
  ...
  const factory SearchProdutcState.sucsess( ListProductModel listProductModel) = Sucsess;
  const factory SearchProdutcState.error(String error) = Error;  
  const factory SearchProdutcState.noInternet() = Nointernet;
  const factory SearchProdutcState.savedSearch(List<SearchModel> savedSearch) = SavedSearch;
}
