...
class SpicificLocationState with _$SpicificLocationState {
  ...
  const factory SpicificLocationState.loaded(
      {required LocationsModel locationModel}) = Loaded;
  const factory SpicificLocationState.error({required String errorMessage}) =
      Error;
  const factory SpicificLocationState.noInternet() = NoInternet;
  const factory SpicificLocationState.loading2() = Loading2;
  const factory SpicificLocationState.loaded2(
      {required DoneModel locationMessageModel}) = Loaded2;
  const factory SpicificLocationState.error2({required String errorMessage}) =
      Error2;
